...
func newFileInfo(fileName string, buffer []byte, streamInfo *streamInfo, fileExtName string) (*fileInfo, error) {
	if fileName != "" {
	...
	return nil, errors.New("choose at least one of buffer, stream, filename")
}
